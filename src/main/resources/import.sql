...
insert into restaurante (nome, taxa_entrega, cozinha_id, endereco_cep, endereco_cidade_id, endereco_bairro, endereco_complemento, endereco_logradouro, endereco_numero) values ('Seu Zé', 7.50, 1, '4500500', 1, 'Candeias', 'Casa', null, '96');
insert into restaurante (nome, taxa_entrega, cozinha_id, endereco_cep, endereco_cidade_id, endereco_bairro, endereco_complemento, endereco_logradouro, endereco_numero) values ('Dona Maria', 5.50, 2, '4500500', 1, 'Recreio', 'Apartamento', null, '500');
