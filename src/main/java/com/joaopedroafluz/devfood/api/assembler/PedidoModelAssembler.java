...
import com.joaopedroafluz.devfood.api.model.*;
...
public class PedidoModelAssembler {
    ...
    public PedidoModel toModel(Pedido pedido) {
        ...
        var estado = EstadoModel.builder()
                .id(pedido.getEnderecoEntrega().getCidade().getEstado().getId())
                .nome(pedido.getEnderecoEntrega().getCidade().getEstado().getNome())
                .sigla(pedido.getEnderecoEntrega().getCidade().getEstado().getSigla())
                .build();
