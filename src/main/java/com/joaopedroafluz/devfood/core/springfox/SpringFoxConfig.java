package com.joaopedroafluz.devfood.core.springfox;
...
import com.joaopedroafluz.devfood.api.openapi.model.CozinhaModelOpenApi;
import com.joaopedroafluz.devfood.api.openapi.model.PageableModelOpenApi;
import com.joaopedroafluz.devfood.api.openapi.model.PedidoResumidoModelOpenApi;
...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    public Docket apiDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.joaopedroafluz.devfood.api"))
                .build()
                .apiInfo(apiInfo())
